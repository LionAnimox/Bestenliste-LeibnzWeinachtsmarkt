...
// Definiertes Passwort im Code (in diesem Fall "7D")
const correctPassword = "7D";
...
// Funktion: Admin-Passwort prüfen
passwordForm.addEventListener("submit", (e) => {
  ...
  if (enteredPassword === correctPassword) {
    ...
    passwordForm.style.display = "none"; // Passwortformular ausblenden
  } else {
